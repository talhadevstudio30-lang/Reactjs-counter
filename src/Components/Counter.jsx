      ...
      <div className="min-h-screen flex items-center justify-center p-6">
        ...
        >
          ...
          data-aos-delay="200"
              ...
              className="text-7xl font-bold text-indigo-600 mb-8 drop-shadow-md relative z-10"
            >
              {value.result}
            </motion.div>
          </AnimatePresence>
          ...
          data-aos-delay="300"
              ...
              onClick={value.plus}
              className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-bold pb-1 px-6 rounded-2xl shadow-md text-3xl"
            >
              +
            </motion.button>
          ...
          data-aos-delay="300"
              ...
              whileHover={{ scale: 1.1 }}
              onClick={value.minus}
              className="bg-gradient-to-r from-red-500 to-pink-500 text-white font-semibold pb-1 py-3 px-6 rounded-2xl shadow-md text-3xl"
            >
              -
            </motion.button>
          </div>
